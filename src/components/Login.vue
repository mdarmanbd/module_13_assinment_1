          ...
          <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <div class="space-y-4 md:space-y-6" action="#">
                      <div>
                          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username : kminchelle</label>
                      ...
                      <div>
                          <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password : 0lelplR</label>
                      ...
                      <p class="text-right">
                          <button @click="auth.authenicate(username,password)" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                              <span>Log in</span>
                          </button>
                      </p>
                  </div>
